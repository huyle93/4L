    ...
    private void handleButtonEvent( int buttonId )
    {
        ...
        switch( buttonId )
        {
            ...
            case 2:
                ...
                floatX = _snowman.getMoveX() * fasterRatio;
                floatY = _snowman.getMoveY() * fasterRatio;
                intx = ( floatX );
                inty = ( floatY );
                
//                if( minStepFlag == true )
//                {
//                    if( intx <   MoverGUI.minStepSize)
//                    {
//                        intx =  MoverGUI.minStepSize;
//                    }
//                    if( inty < 3 )
//                    {
//                        inty = 3;
//                    }
                _snowman.setMove( intx, inty );
//                }
//                else
//                {
//                    _snowman.setMove( intx, inty );
//                }
            ...
            case 3:
                ...
                floatX = _snowman.getMoveX() * slowerRatio;
                floatY = _snowman.getMoveY() * slowerRatio;
                intx = ( floatX );
                inty = ( floatY );
